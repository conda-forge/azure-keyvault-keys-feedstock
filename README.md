...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/azure-keyvault-keys-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/azure-keyvault-keys-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add azure-keyvault-keys
# for installing globally
pixi global install azure-keyvault-keys
```
...
It is possible to list all of the versions of `azure-keyvault-keys` available on your platform:
...
```
pixi search azure-keyvault-keys --channel conda-forge
```
